package team.zeds.structured.block
...
import team.zeds.structured.api.EntityBlockBase
...
class MultiCoreBlock: EntityBlockBase<MultiCoreBlockEntity>({ pos, state-> MultiCoreBlockEntity(pos, state) },
    ...
    override fun use(
        ...
        val blockEntity = level.getBlockEntity(pos) as MultiCoreBlockEntity
        blockEntity.onOpen(player, pos)
